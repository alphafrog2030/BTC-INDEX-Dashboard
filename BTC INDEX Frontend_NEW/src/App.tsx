        ...
        <div className="max-w-4xl mx-auto animate-fadeIn space-y-8">
          <div className="bg-slate-800 p-4 sm:p-6 rounded-xl border border-slate-700 shadow-lg">
            ...
            <div className="prose prose-invert prose-cyan max-w-none">
              <ReactMarkdown
                components={{
                  h1: ({ node, ...props }) => <h1 className="text-lg font-bold text-cyan-400 mb-4 mt-6 pb-2 border-b border-slate-700" {...props} />,
                  h2: ({ node, ...props }) => <h2 className="text-base font-bold text-white mb-3 mt-4" {...props} />,
                  h3: ({ node, ...props }) => <h3 className="text-sm font-bold text-slate-200 mb-2 mt-3" {...props} />,
                  p: ({ node, ...props }) => <p className="mb-3 text-sm leading-relaxed text-slate-300" {...props} />,
                  li: ({ node, ...props }) => <li className="mb-1 ml-4 list-disc text-sm text-slate-300 pl-1" {...props} />,
